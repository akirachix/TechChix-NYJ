    ...
    return(
     <div>
        <div className="heading">
            ...
            <p>
                <h2>Summary</h2>
                Born a crime explains how apatheid in south Africa separated the country into two tribes Zuluad and Xhosa Born There was a warfare among these two tribes . The fierce Zulu tribe were wiped out after they restricted . European invaders 
            ...
            <p>
                <h2>Social</h2>
                Humor as a coping mechanism . This apprach helped him in navigating through difficult circumstances , an example is when Trevor and the mother escaped from a moving vihivcle where the driver wanted to harm them . This approach offers a lens to process and reflect on the challanging society's issues . <a className="link" href="https://docs.google.com/document/d/1W3MaWDTuk-v8s4mW0zW6WfIjGNDg0maRV0pB_fIdudI/edit">ReadMore</a>
                </p>
